...
##
## Debug
ProjectName            :=CSES_PROBLEM_SET_Palindrome_Reorder
ConfigurationName      :=Debug
WorkspacePath          :="D:/New folder (2)/PRACTICE/CSES_PROBLEM_SET"
ProjectPath            :="D:/New folder (2)/PRACTICE/CSES_PROBLEM_SET/CSES_PROBLEM_SET_Palindrome_Reorder"
IntermediateDirectory  :=$(ConfigurationName)
OutDir                 := $(IntermediateDirectory)
CurrentFileName        :=
CurrentFilePath        :=
CurrentFileFullPath    :=
User                   :=Parmanand kumar
Date                   :=18/07/2023
...
ObjectsFileList        :="CSES_PROBLEM_SET_Palindrome_Reorder.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/New folder (2)/PRACTICE/CSES_PROBLEM_SET/CSES_PROBLEM_SET_Palindrome_Reorder/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
